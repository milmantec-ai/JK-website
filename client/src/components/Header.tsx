    ...
    <header className="w-full sticky top-0 z-50" role="banner">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="https://www.instagram.com/jkbairava_painting/" target="_blank" rel="noopener noreferrer" className="hover:text-green-400 transition-colors" aria-label="Instagram">
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
